...
//Mock data for InterviewerItemList
const interviewer = {
  id: 1,
  name: "Sylvia Palmer",
...
//Mock data for InterviewerList testing
...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form student="Gord Letkeman" interviewer={0} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
